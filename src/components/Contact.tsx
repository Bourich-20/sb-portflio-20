    ...
    <div className={`flex flex-col items-center justify-center w-full min-h-[700px] px-4 pt-7 rounded-t-lg border border-gray-300 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-blue-200 text-black'}`}>
        ...
        <div className="flex flex-col lg:flex-row w-full max-w-5xl">
            ...
            <motion.form
                ...
                className={`rounded-lg shadow-lg p-6 w-full lg:w-1/2 ${isDarkMode ? 'bg-gray-800' : 'bg-blue-100'}`}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 1 }}
            >
                ...
                <div className="mb-4">
                    ...
                    <input
                        ...
                        className={`w-full p-2 border rounded focus:outline-none focus:ring-2 ${isDarkMode ? 'bg-gray-700 text-white border-gray-600 focus:ring-yellow-500' : 'bg-white border-gray-300 focus:ring-blue-500'}`}
                        required
                    />
                </div>
